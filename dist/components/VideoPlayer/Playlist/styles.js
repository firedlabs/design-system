...
exports.PlaylistStyle = exports.WrapperLesson = exports.VideosLesson = exports.Videos = exports.MenuLesson = exports.Lesson = exports.IconWrapper = exports.PlaylistIcon = exports.Tag = void 0;
...
var Tag = _styledComponents.default.div(_templateObject(), _Tools.Caption);
...
var IconWrapper = (0, _styledComponents.default)(_IconPlayer.IconPlayerWrapper)(_templateObject3());
...
var Lesson = _styledComponents.default.a(_templateObject5(), _Tools.Cursor.hover, hasActive);

exports.Lesson = Lesson;

var hasOpen = function hasOpen(_ref2) {
  var open = _ref2.open;
  return open && (0, _styledComponents.css)(_templateObject6(), Lesson);
};

var MenuLesson = _styledComponents.default.menu(_templateObject7(), _Tools.Subtitle, _Tools.Cursor.hover, hasOpen);

exports.MenuLesson = MenuLesson;

var Videos = _styledComponents.default.div(_templateObject8(), function (_ref3) {
...
var VideosLesson = _styledComponents.default.section(_templateObject9());

exports.VideosLesson = VideosLesson;

var hasPlaylistOpen = function hasPlaylistOpen(_ref4) {
  var playlistOpen = _ref4.playlistOpen;
  return playlistOpen && (0, _styledComponents.css)(_templateObject10());
};

var WrapperLesson = _styledComponents.default.section(_templateObject11(), (0, _polished.transparentize)(0.1, _palette.palette.colorSecond), hasPlaylistOpen);

exports.WrapperLesson = WrapperLesson;

var PlaylistStyle = _styledComponents.default.div(_templateObject12());
